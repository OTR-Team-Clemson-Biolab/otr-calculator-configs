function ModifiedData = AMBRCHO_Historical_PostScript(Data)
...
% record absolute pressure. This is for historical datasets, in which the
% atmospheric pressure data is fetched from NOAA.
%
